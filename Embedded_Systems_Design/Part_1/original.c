...
#define file_y_init "./outputs/dog_init.y"
#define file_u_init "./outputs/dog_init.u"
#define file_v_init "./outputs/dog_init.v"
#define file_y_final "./outputs/dog_final.y"
#define file_u_final "./outputs/dog_final.u"
#define file_v_final "./outputs/dog_final.v"
...
//chose this code form Stackoverflow because it achieves the result with minimum number of instructions
